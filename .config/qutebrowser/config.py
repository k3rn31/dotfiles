...
## Type: Font
c.fonts.monospace = '"JetBrains Mono", "Fira Mono", "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
config.bind('<Ctrl-B>', 'spawn --userscript qute-bitwarden -w', mode='insert')
